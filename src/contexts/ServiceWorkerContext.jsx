...
export const ServiceWorkerProvider = ({ children }) => {
  ...
  return (
    <ServiceWorkerContext.Provider value={serviceWorkerUtils}>
      {children}
      {serviceWorkerUtils.updateAvailable && (
        <UpdateNotification onUpdate={serviceWorkerUtils.updateServiceWorker} />
      )}
    ...
    <div className="fixed bottom-4 right-4 bg-blue-50 dark:bg-blue-900 p-4 rounded-lg shadow-lg">
      <div className="flex items-center">
        ...
        <div className="ml-auto pl-3">
          <button
            onClick={onUpdate}
            className="inline-flex rounded-md bg-blue-100 dark:bg-blue-800 px-3 py-1.5 text-sm font-medium text-blue-800 dark:text-blue-200 hover:bg-blue-200 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Update Now
          </button>
        </div>
